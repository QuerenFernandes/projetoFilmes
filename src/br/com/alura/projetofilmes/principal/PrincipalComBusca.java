...
import br.com.alura.projetofilmes.modelos.TituloOmdb;
...
public class PrincipalComBusca {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while(!busca.equalsIgnoreCase("sair")) {
            ...
            String endereco = "https://www.omdbapi.com/?t=" + busca.replace(" ", "+") + "&apikey=1b84eb5c";
            try {
                ...
                /*CRIANDO ARQUIVO EM TXT
                FileWriter escrita = new FileWriter("filme.txt");
                escrita.write(meuTitulo.toString());
                escrita.close();*/

            } catch (NumberFormatException e) {
                System.out.println("Foi identificado um erro: ");
